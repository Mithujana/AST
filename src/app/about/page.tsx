      ...
      <section className="relative pt-24 pb-14 sm:pt-28 sm:pb-18 md:pt-32 md:pb-20 bg-[#062B68] overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-2xl">
            ...
            {/* Main Title */}
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[50px] font-bold text-white tracking-tight leading-[1.15] mb-4 font-serif">
            ...
            {/* Subtitle */}
            <p className="text-sm sm:text-base md:text-lg text-slate-200 leading-relaxed font-normal mb-6 max-w-xl">
